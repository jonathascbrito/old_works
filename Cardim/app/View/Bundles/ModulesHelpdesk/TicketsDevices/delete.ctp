...
<div class="body">
    <?php if (isset($success)) : ?>
        <p>O sistema <?php echo $device['TicketDevice']['name']; ?> foi apagado com sucesso!</p>
    ...
    <?php else : ?>
        <form id="delete" method="delete">
            ...
            <p>Tem certeza de que deseja apagar o sistema <?php echo $device['TicketDevice']['name']; ?>?</p>
