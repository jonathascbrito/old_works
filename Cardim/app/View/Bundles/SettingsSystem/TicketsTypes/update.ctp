...
<div class="body">
    <?php if (isset($success)) : ?>
        <p>O tipo de chamado <?php echo $this->request->data['TicketType']['name']; ?> foi atualizado com sucesso!</p>
        ...
        <form id="update" method="put">
            ...
            <div class="form-actions right">
                ...
                <?php
                    ...
                    echo $this->App->createmodalbutton('Salvar', 'open', '/settings/system/types/update/' . $id);
                ?>
            </div>
