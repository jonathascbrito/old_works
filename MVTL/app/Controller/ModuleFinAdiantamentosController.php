 ...
 * da aplicação.
 */
class ModuleFinAdiantamentosController extends AppController
{
     ...
     * @var string
     */
    public $path = 'Adiantamentos';
    public $bundle = 'ModulesFin';

    protected function all() {
        $this->paginate['conditions']['and'][] = 'Transaction.type in (2)';
    }
    ...
    public function index($filter = 'all') {
        ...
        $this->set('title', 'Módulos > Financeiro > Adiantamentos');
