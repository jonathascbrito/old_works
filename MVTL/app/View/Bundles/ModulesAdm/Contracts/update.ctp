...
<div class="body">
    <?php if (isset($success)) : ?>
        <p>O contrato foi atualizado com sucesso!</p>
    ...
    <?php else : ?>
        <form id="update" method="put">
            ...
            <?php echo $this->App->createinput('', 'Contract.id', 'hidden'); ?>
            ...
            <div class="form-actions right">
                ...
                <?php
                    ...
                    echo $this->App->createmodalbutton('Salvar', 'open', '/modules/adm/contracts/update/' . $id);
                ?>
            </div>
