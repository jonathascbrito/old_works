...
<div class="body">
    <?php if (isset($success)) : ?>
        <p>O adiantamento foi atualizado com sucesso!</p>
    ...
    <?php else : ?>
        <form id="update" method="put">
            ...
            <?php
                $this->App->setattribute('value', '00/00/0000');
                echo $this->App->createinput(false, 'Transaction.bill_date', 'hidden');
            ?>s

            <?php
                $this->App->setattribute('input-mask', '99\/99\/9999');
                echo $this->App->createinput('Data', 'Transaction.pay_date');
            ?>

            <?php
                echo $this->App->createinput('Valor', 'Transaction.value');
            ?>
            ...
            <div class="form-actions right">
                ...
                <?php
                    ...
                    echo $this->App->createmodalbutton('Salvar', 'open', '/modules/fin/transactions/adiantamentos/update/' . $id);
                ?>
            </div>
