...
<div id="content">
    ...
    <div id="actions">
        <?php echo $this->App->createmodalbutton('Nova Movimentação', 'open', '/modules/fin/transactions/create'); ?>
        ...
        <?php echo $this->App->createmodalbutton('Editar', 'open', '/update/module_fin_transactions'); ?>
        ...
        <table class="table">
            <thead>
                <tr>
                    ...
                    <th></th>
                    <th><?php echo $this->Paginator->sort('pay_date', 'Vencimento'); ?></th>
                </tr>
            </thead>
            ...
            <tbody>
                ...
                <?php if ($transactions) { foreach ($transactions as $transaction): ?>
                    ...
                    <tr>
                        ...
                        <td><?php echo $transaction['Transaction']['pay_date']; ?></td>
                    </tr>
