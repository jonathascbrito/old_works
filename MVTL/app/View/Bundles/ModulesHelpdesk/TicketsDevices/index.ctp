...
<div id="content">
    <?php
        $this->start('breadcrumb');
            ...
            echo $this->App->createlink('Equipamentos', '/modules/helpdesk/devices');
        $this->end();
    ...
    <div id="actions">
        <?php echo $this->App->createmodalbutton('Novo Equipamento', 'open', '/modules/helpdesk/devices/create'); ?>
            ...
            <tbody>
                <?php foreach ($devices as $device): ?>
                    ...
                    <tr>
                        ...
                        <td><?php echo $device['TicketDevice']['type']; ?></td>
                        <td><?php echo $device['TicketDevice']['code']; ?></td>
