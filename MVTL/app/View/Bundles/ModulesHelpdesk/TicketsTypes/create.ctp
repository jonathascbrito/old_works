<h2>Novo Tipo de Ticket</h2>

<div class="body">
    <?php if (isset($success)) : ?>
        <p>O tipo de ticket <?php echo $this->request->data['TicketType']['name']; ?> foi cadastrado!</p>
        ...
        <form id="create" method="post">
            ...
            <div class="form-actions right">
                ...
                <?php
                    ...
                    echo $this->App->createmodalbutton('Salvar', 'open', '/modules/helpdesk/types/create');
                ?>
            </div>
