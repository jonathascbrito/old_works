...
<div id="content">
    <?php
        $this->start('breadcrumb');
            echo $this->App->createlink('Clientes', '/modules/entities');
        $this->end();
    ...
    <div id="actions">
        <?php echo $this->App->createmodalbutton('Novo Cliente', 'open', '/modules/entities/create'); ?>
        ...
        <table class="table">
            ...
            <tbody>
                <?php foreach ($entities as $entity): ?>
                    ...
                    <tr modal-action="open" modal-url="<?php echo $this->App->createurl('/modules/entities/view/' . $entity['Entity']['id']); ?>">
                        <td>
                            <?php
                                $this->App->setattribute('type', 'checkbox');
