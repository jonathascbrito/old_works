...
<div class="body">
    <?php if (isset($success)) : ?>
        <p>A nota fiscal foi atualizada com sucesso!</p>
    ...
    <?php else : ?>
        <form id="create" method="post">
            ...
            <?php echo $this->App->createinput('', 'ContractBilling.id', 'hidden', $contractBilling['ContractBilling']['id']); ?>
            ...
            <div class="form-actions right">
                ...
                <?php
                    ...
                    echo $this->App->createmodalbutton('Salvar', 'open', '/modules/fin/faturamento/update/' . $contract['Contract']['id'] . '/' . $contractBilling['ContractBilling']['id']);
                ?>
            </div>
